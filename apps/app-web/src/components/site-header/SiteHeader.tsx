...
export function SiteHeader() {
  return (
    <div className="site-header-container">
      <div className="site-header-container1">
        <h1 className="site-header-text">Simpd.</h1>
      </div>
      <header data-role="Header" className="site-header-header">
        <nav className="site-header-nav">
          <Link to="/dashboard" className="site-header-navlink">
            <svg viewBox="0 0 1024 1024" className="site-header-icon">
              <path
          ...
          <Link to="/notifications" className="site-header-navlink1">
            <svg viewBox="0 0 1024 1024" className="site-header-icon02">
              <path
          ...
          <Link to="/messages" className="site-header-navlink2">
            <svg viewBox="0 0 1152 1024" className="site-header-icon04">
              <path
          ...
          <Link to="/favorites" className="site-header-navlink3">
            <svg viewBox="0 0 1024 1024" className="site-header-icon06">
              <path
          ...
          <Link to="/user-profile" className="site-header-navlink4">
            <svg viewBox="0 0 1024 1024" className="site-header-icon08">
              <path
          ...
          <Link to="/settings-profile" className="site-header-navlink5">
            <svg viewBox="0 0 1024 1024" className="site-header-icon10">
              <path
