export * from './svc-aws/aws-client.decorator';
export * from './svc-aws/aws-client.service';
export * from './svc-aws/aws.const';
export * from './svc-aws/aws.types';
export * from './svc-aws/aws.module';
